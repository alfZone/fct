...
$table->prepareTable("fctCursos");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("ID, Nome, NomeCurto ",'list');
$table->setFieldsAtive("Nome, NomeCurto", 'new');
$table->setFieldsAtive("Nome, NomeCurto", 'edit');
$table->setFieldsAtive("Nome, NomeCurto", 'csv');
...
$table->setFieldList("IDcurso",1," SELECT `ID`, `NomeCurso` FROM `fctCursos` ORDER BY `NomeCurso`;");
...
//Labels for fields
$table->setLabel('NomeCurto',"Nome Curto");
