...
Route::get('/prof', function () {
  require _CAMINHO_TEMPLATE . "prof-menu.html";
});
Route::get('/prof/dados', function () {
  require _CAMINHO_TEMPLATE . "prof.html";
});
...
Route::get('/empresa', function () {
  require _CAMINHO_TEMPLATE . "emp-menu.html";
});
...
Route::get('/dc', function () {
  require _CAMINHO_TEMPLATE . "dc.html";
});
Route::get('/dc/distribuir', function () {
  require _CAMINHO_TEMPLATE . "distribuiralunos.html";
});
Route::get('/dc/{id}', function () {
  require _CAMINHO_TEMPLATE . "dc.html";
});
