...
Route::get('/pdf/caderneta-a5', function(){require _CAMINHO_TEMPLATE. "/pdf/cadernetaa5.php";});
...
Route::get('/aluno/dados', function(){require _CAMINHO_TEMPLATE. "estagiario.html";});
