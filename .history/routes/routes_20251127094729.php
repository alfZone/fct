...
Route::get('/aluno/estagiar', function(){require _CAMINHO_TEMPLATE. "estagiario.html";});
Route::get('/aluno/empresa', function(){require _CAMINHO_TEMPLATE. "dadosEmpresa.html";});

//dc
Route::get('/dc/menu', function(){require _CAMINHO_TEMPLATE. "aluno.menu.html";});
Route::get('/dc/estagiar', function(){require _CAMINHO_TEMPLATE. "estagiario.html";});
Route::get('/dc/empresa', function(){require _CAMINHO_TEMPLATE. "dadosEmpresa.html";});
