...
Route::get('/distribuirdc', function(){require _CAMINHO_TEMPLATE. "distribuiralunos.html";});
...
//profs
Route::get('/professor/menu', function(){require _CAMINHO_TEMPLATE. "aluno.menu.html";});
Route::get('/professor/dados', function(){require _CAMINHO_TEMPLATE. "alunos.html";});
...
Route::get('/dc/distribuirdc', function(){require _CAMINHO_TEMPLATE. "distribuiralunos.html";});
