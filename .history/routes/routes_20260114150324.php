...
Route::get('/admin/empresas-vagas', function () {
  require _CAMINHO_ADM . "empresasVagasManager.php";
});
Route::post('/admin/empresas-vagas', function () {
  require _CAMINHO_ADM . "empresasVagasManager.php";
});
...
Route::get(['set' => '/api/anosletivos/ativo', 'as' => 'anosletivos.getAnoAtivo'], 'ControllerAnosletivos@getAnoAtivo');
...
Route::get(['set' => '/api/empresas/email', 'as' => 'empresas.getEmail'], 'ControllerEmpresas@getEmail');
Route::get(['set' => '/api/empresas/{id}', 'as' => 'empresas.getById'], 'ControllerEmpresas@getById');
Route::get(['set' => '/api/empresas/{nif}/cursos', 'as' => 'empresas.getCursosById'], 'ControllerEmpresas@getCursosById');
...
Route::post(['set' => '/api/empresas/{NIF}/curso/{idCurso}', 'as' => 'empresas.addEmpresaToCurso'], 'ControllerEmpresas@addEmpresaToCurso');
...
Route::gpost(['set' => '/api/estagiarios/add-matriculas', 'as' => 'estagiarios.inscreverMatriculadosParaEstagio'], 'ControllerEstagiarios@inscreverMatriculadosParaEstagio');
