...
//Authentication
Route::get('/admin', function(){require _CAMINHO_TEMPLATE. "login.html";});
Route::get('/admin/in', function(){require _CAMINHO_TEMPLATE. "index.php";});
...
//aluno
Route::get('/alunos', function(){require _CAMINHO_TEMPLATE. "aluno.menu.html";});
...
Route::get('/alunos/{id}', function(){require _CAMINHO_TEMPLATE. "aluno.menu.html";});

//profs
Route::get('/prof', function(){require _CAMINHO_TEMPLATE. "prof-menu.html";});
Route::get('/prof/dados', function(){require _CAMINHO_TEMPLATE. "prof.html";});
Route::get('/prof/empresa', function(){require _CAMINHO_TEMPLATE. "dadosEmpresa.html";});
Route::get('/prof/{id}', function(){require _CAMINHO_TEMPLATE. "prof-menu.html";});

//empresas
Route::get('/empresa', function(){require _CAMINHO_TEMPLATE. "emp-menu.html";});
Route::get('/empresa/{id}', function(){require _CAMINHO_TEMPLATE. "emp-menu.html";});
...
Route::get('/dc/{id}', function(){require _CAMINHO_TEMPLATE. "dc.html";});
...
//menu admin
Route::get('/admin', function(){require _CAMINHO_TEMPLATE. "menu-admin.html";});

//menu inicial
Route::get('/inicial', function(){require _CAMINHO_TEMPLATE. "menu-inicial.html";});

//turma
Route::get('/turma', function(){require _CAMINHO_TEMPLATE. "turma.html";});
...
Route::get('/admin/empresas', function(){require _CAMINHO_ADM. "empresasManager.php";});
Route::post('/admin/empresas', function(){require _CAMINHO_ADM. "empresasManager.php";});
Route::get('/admin/documentos', function(){require _CAMINHO_ADM. "documentosManager.php";});
Route::post('/admin/documentos', function(){require _CAMINHO_ADM. "documentosManager.php";});
Route::get('/admin/professores', function(){require _CAMINHO_ADM. "professoresManager.php";});
Route::post('/admin/professores', function(){require _CAMINHO_ADM. "professoresManager.php";});
Route::get('/admin/estagiarios', function(){require _CAMINHO_ADM. "estagiariosManager.php";});
Route::post('/admin/estagiarios', function(){require _CAMINHO_ADM. "estagiariosManager.php";});
