...
Route::get('/pdf', function(){require _CAMINHO_CLASSES. "/fpdf/tutorial/tuto2.php";});
...
//api anos letivos
Route::get(['set' => '/api/anosLetivos', 'as' => 'anosLetivos.getById'], 'ControllerAnosLetivos@getById');
