...
Route::get('/pdf/modelo', function(){require _CAMINHO_TEMPLATE. "/pdf/caderneta.php";});
...
//api aluno/menu
Route::get(['set' => '/api/aluno/menu', 'as' => 'alunomenu.getAll'], 'ControllerAlunomenu@getAll');
Route::get(['set' => '/api/aluno/menu/{processo}', 'as' => 'alunomenu.getById'], 'ControllerAlunomenu@getById');
Route::post(['set' => '/api/aluno/menu', 'as' => 'alunomenu.create'], 'ControllerAlunomenu@create');
Route::put(['set' => '/api/aluno/menu', 'as' => 'alunomenu.update'], 'ControllerAlunomenu@update');
Route::delete(['set' => '/api/aluno/menu/{processo}', 'as' => 'alunomenu.delete'], 'ControllerAlunomenu@delete');
