...
Route::get('/professor/dados', function(){require _CAMINHO_TEMPLATE. "prof.html";});
Route::get('/professor/empresa', function(){require _CAMINHO_TEMPLATE. "dadosEmpresa.html";});
