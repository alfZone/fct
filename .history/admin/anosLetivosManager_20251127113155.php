...
//SELECT `ID`, `Anoletivo`, `Ativo` FROM `fctAnosletivos` WHERE 1
//select the table in the datebase
$table->prepareTable("fctAnosletivos");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("ID, Anoletivo,Ativo",'list');
$table->setFieldsAtive("Anoletivo, Ativo", 'new');
$table->setFieldsAtive("Anoletivo, Ativo", 'edit');
$table->setFieldsAtive("Anoletivo, Ativo", 'csv');
...
$table->setFieldList("Ativo",2,"1=>Active,0=>Inactive",1);
...
//Labels for fields
$table->setLabel('Anoletivo',"Ano Letivo");
