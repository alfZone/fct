...
$table->setFieldsAtive("Processo, Nome, Email, Telefone, DC",'list');
$table->setFieldsAtive("Processo, Nome, Email, Telefone, DC", 'new');
$table->setFieldsAtive("Processo, Nome, Email, Telefone, DC", 'edit');
$table->setFieldsAtive("Processo, Nome, Email, Telefone, DC", 'csv');
...
$table->setFieldList("DC",3," SELECT `ID`,`Nome` FROM `fctCursos` order by `Nome` |0=>Professor,1=>Diretor de Curso,2=>Coordenador");
