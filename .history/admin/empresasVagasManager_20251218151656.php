...
$table->setFieldsAtive("id, NIF, IdCurso, IDAnoLetivo, NumVagas", 'list');
$table->setFieldsAtive("NIF, IdCurso, IDAnoLetivo, NumVagas, Obs", 'new');
$table->setFieldsAtive("NIF, IdCurso, IDAnoLetivo, NumVagas, Obs", 'edit');
$table->setFieldsAtive("NIF, IdCurso, IDAnoLetivo, NumVagas, Obs", 'csv');
