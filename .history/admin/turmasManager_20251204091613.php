...
$table->setFieldsAtive("NomeTurma, IDAnoLetivo, IDcurso",'list');
...
$table->setFieldList("IDAnoLetivo",1," SELECT `ID`, `NomeTurma` FROM `fctTurmas` ORDER BY `NomeTurma`;");
...
//Labels for fields
$table->setLabel('NomeTurma',"Nome da Turma");
$table->setLabel('IDAnoLetivo',"ID do Ano Letivo");
$table->setLabel('IDcurso',"ID do Curso");
