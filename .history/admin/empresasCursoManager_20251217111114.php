...
$table->setFieldList("NIF", 2, " SELECT `NIF`, `NomeEmpresa` FROM `fctEmpresas` order by `NomeEmpresa`;");
$table->setFieldList("IdCurso", 3, " SELECT `ID`, `Nome` FROM `fctCursos` order by Nome;|0=>Não definido");
