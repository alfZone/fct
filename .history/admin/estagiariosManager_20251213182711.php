...
$table->setFieldList("Processo", 3, " SELECT `Processo`, `Nome` FROM `fctAlunos` order by `Nome`;|0=>Não definido");
...
$table->setFieldList("ProcessoProf", 3, " SELECT `Processo`, `NomeEmpresa` FROM `fctEmpresas` order by `NomeEmpresa`;|0=>Não definido");
...
//Labels for fields
$table->setLabel('IDAnoLetivo', "Ano Letivo");
