...
$table->setFieldsAtive("Processo, Nome, Email, Contribuinte",'list');
$table->setFieldsAtive("Processo, Nome, Morada, Contacto, Email, DataNascimento, CC, Contribuinte, NomeEE, ContactoEE, IDturma", 'new');
$table->setFieldsAtive("Processo, Nome, Morada, Contacto, Email, DataNascimento, CC, Contribuinte, NomeEE, ContactoEE, IDturma", 'edit');
$table->setFieldsAtive("Processo, Nome, Morada, Contacto, Email, DataNascimento, CC, Contribuinte, NomeEE, ContactoEE, IDturma", 'csv');
...
$table->setFieldList("IDturma",1," SELECT `id`,`type` FROM `tabUsersTypes` ORDER BY `type`");
