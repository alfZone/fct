...
$table->setFieldsAtive("NIF, NomeEmpresa, Cargo, MoradaSede, ContactoEmpresa, HorarioFuncionamento, HorasDia, Monitor, CargoMonitor, Telefone, Observações, Email, ResponsavelEstagiario",'list');
