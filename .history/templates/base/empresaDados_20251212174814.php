...
<body>
      ...
      <form id="formEmpresa">
        <div class="row g-4">
          ...
          <div class="col-12">
            ...
            <div class="row g-3">
              <div class="col-md-6"><input type="text" class="form-control" id="resp_nome" placeholder="Primeiro Nome" required></div>
            </div>
          </div>
  ...
  <script>
    const atualizarEmpresa = async () => {
      ...
      document.getElementById("empresa").value = lv[0].ResponsavelEstagiario;
      document.getElementById("cargo").value = lv[0].Cargo;
      document.getElementById("email").value = lv[0].Email;
      document.getElementById("telefone").value = lv[0].Telefone;
    };
