      ...
      <form id="formEmpresa">
        ...
        <div class="container">
          <div class="row text-end mt-5">
            ...
            <div class="col-md-6">
              <button type="button" id="btnEnviar" class="btn btn-danger btn-save" onclick="location.href='../prof'">Fechar</button>
            </div>
          </div>
        </div>

        <div class="text-end mt-5">
          <button type="button" class="btn btn-success btn-save" onclick="updateData()">
            Guardar Dados
          </button>
        </div>
      </form>
