        ...
        <div class="container">
          <div class="row text-end mt-5">
            <div class="col-md-4">
              ...
              <button type="button" id="btnEnviar" class="btn btn-success btn-save" onclick="">Adicionar ao Curso</button>
            </div>
            <div class="col-md-4">
  ...
  <script>
    ...
    const addEmpresaCurso = async () => {
      try {
        ...
        const response = await fetch("https://turma12r.alunos.esmonserrate.org/fct/public/api/empresas/<?=  ?>/curso/{idCurso}", {
