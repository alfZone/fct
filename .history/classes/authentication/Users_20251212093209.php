...
class Users extends LayerDB
{
  ...
  public $instrucaoSQL = array(
    "loginGoogle" => 'SELECT `Processo` as id, `Nome` as name, `Email` as email, `Telefone`, `DC` as type, `ativo` FROM `fctProfessores` WHERE email=:email and ativo=1',
