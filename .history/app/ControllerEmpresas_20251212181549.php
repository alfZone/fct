...
class ControllerEmpresas
{
    ...
    public function update()
    {
        ...
        $resp = $this->database->setData("UPDATE `fctEmpresas` SET `NIF`=:NIF,`NomeEmpresa`=:NomeEmpresa,`Cargo`=:Cargo,`ResponsavelEstagiario`=:ResponsavelEstagiario,`MoradaSede`=:MoradaSede,`ContactoEmpresa`=:ContactoEmpresa,`HorarioFuncionamento`=:HorarioFuncionamentoappa<|fim_middle|>
        echo json_encode($resp, JSON_UNESCAPED_UNICODE);
    }
