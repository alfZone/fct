...
class ControllerEmpresas
{
    ...
    public function update()
    {
        ...
        $resp = $this->database->setData("UPDATE `fctEmpresas` SET `NIF`='[value-1]',`NomeEmpresa`='[value-2]',`Cargo`='[value-3]',`ResponsavelEstagiario`='[value-4]',
                                            `MoradaSede`='[value-5]',`ContactoEmpresa`='[value-6]',`HorarioFuncionamento`='[value-7]',`HorasDia`='[value-8]',
                                            `Monitor`='[value-9]',`CargoMonitor`='[value-10]',`Telefone`='[value-11]',`Observacoes`='[value-12]',`Email`='[value-13]' WHERE NIF = :NIF", $p);
        echo json_encode($resp, JSON_UNESCAPED_UNICODE);
    }
