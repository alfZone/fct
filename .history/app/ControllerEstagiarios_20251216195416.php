...
class ControllerEstagiarios
{
    ...
    public function createEstagiarios($curso)
    {
        ...
        $aluno = $this->database->getData("SELECT `Processo`, fctTurmas.IDcurso as Curso, fctTurmas.IDAnoLetivo FROM `fctAlunos` inner join fctTurmas on fctTurmas.id=IDturma  WHERE  fctTurmas.IDcurso = :curso 
