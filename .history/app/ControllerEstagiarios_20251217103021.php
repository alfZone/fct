...
class ControllerEstagiarios
{
    ...
    public function createEstagiariosAnoCurso($curso)
    {
        ...
        if ($aluno[0]['numElements']) {
            foreach ($aluno as $estagiario) {
                $pEstagiario['Processo'] = $estagiario['Processo'];
                $pEstagiario['Nome'] = $estagiario['Nome'];
                $pEstagiario['Morada'] = '';
                $pEstagiario['Contacto'] = '';
                $pEstagiario['Email'] = '';
                $pEstagiario['DataNascimento'] = '';
                $pEstagiario['CC'] = '';
                $pEstagiario['Contribuinte'] = '';
                $pEstagiario['NomeEE'] = '';
                $pEstagiario['ContactoEE'] = '';
                $pEstagiario['IDturma'] = $estagiario['IDturma'];
                $resp = $this->database->setData("INSERT INTO fctEstagiarios (Processo, Nome, Morada, Contacto, Email, DataNascimento, CC, Contribuinte, NomeEE, ContactoEE, IDturma, IDAnoLetivo) 
                                                    VALUES (:Processo, :Nome, :Morada, :Contacto, :Email, :DataNascimento, :CC, :Contribuinte, :NomeEE, :ContactoEE, :IDturma, :IDAnoLetivo)", $pEstagiario);
            }
        }
