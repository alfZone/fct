...
class ControllerEmpresas
{
    ...
    public function update()
    {
        ...
        `MoradaSede`=:MoradaSede,`ContactoEmpresa`=:ContactoEmpresa,`HorarioFuncionamento`=:HorarioFuncionamento,`HorasDia`=:HorasDia,`Monitor`=:Monitor,`CargoMonitor`=:CargoMonitor,`Email`=:Email,`Observacoes`=:Observacoes WHERE NIF = :NIF", $p);
        echo json_encode/code integrado com o código do frontend para atualizar os dados da empresa.zzzzzzz
    {
        $p['id'] = $id;
