    ...
    public function createEstagiariosAnoCurso($curso)
    {
        ...
        if ($aluno[0]['numElements'] > 0   ) {
            foreach ($aluno as $estagiario) {
                ...
                $resp = $this->database->setData("INSERT INTO `fctEstagiarios`(`NIF`, `Processo`, `IDAnoLetivo`, `ProcessoProf`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]'), $pEstagiario);
            }
        }
