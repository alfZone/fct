    ...
    public function update() {
        ...
        if (json_last_error() === JSON_ERROR_NONE) {
         ...
         $p['NIF'] = $putData['NIF']   ;
          ...
          $p['ResponsavelEstagiario'] = $put<|fim_middle|><|fim_middle|>->{$Emp<|fim_middle|><|fim_middle|> pami_fu-ish_empresaapis逍hifttributes<|fim_middle|>elas(ed俶/input<|fim_middle|><|fim_middle|>Empingular_esmonserrate.org/fct/public/api/empresas/", {
        method: "ES<|fim_middle|>
         $p['NIF'] = $putData['NIF']   ;
          Nome NomeJSON = $putData['NomeEmpresa'];
          CargoEmpdatapEmp(edteste Cedviar lulCompanyId<|fim_middle|> TeAppNameucks defaultProps(es_evaleria Folk<|fim_middle|>(edA elaborate-looking for a specific value in an array.
