...
class ControllerEmpresas
{
    ...
    public function update()
    {
        ...
        $resp = $this->database->setData("UPDATE fctEmpresas SET `Empresa`='[value-2]',`Cargo`='[value-3]',`Morada`='[value-4]',`Contacto_Pessoa`='[value-5]',`Horario`='[value-6]',`Duracao`='[value-7]',`Nome_Contacto`='[value-8]',`Cargo_Contacto`='[value-9]',`Telefone_Email`='[value-10]',`Observacoes`='[value-11]' WHERE id = :id", $p);
        echo json_encode($resp, JSON_UNESCAPED_UNICODE);
    }
