      ...
      for (const dataRecord of dataArray) {
        strHtml += `
                        <tr>
                            ...
                            <td>${dataRecord.Morada}</td>
                            <td>
                                <button type="button" class="btn btn-outline-info bedit" onclick="location.href='/fct/public/prof/alunos/${dataRecord.Processo}'"><i class="bi bi-pencil"></i></button>
                            </td>
                            </tr>
                        `;
      }
